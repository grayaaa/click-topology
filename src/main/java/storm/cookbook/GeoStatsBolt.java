...
public class GeoStatsBolt extends BaseRichBolt {
  ...
  public void execute(Tuple tuple) {
    ...
    collector.emit(new Values(country, stats.get(country).getCountryTotal(), city, stats.get(country)
        .getCityTotal(city)));
  ...
  public void declareOutputFields(OutputFieldsDeclarer outputFieldsDeclarer) {
    outputFieldsDeclarer.declare(new backtype.storm.tuple.Fields(storm.cookbook.Fields.COUNTRY,
        storm.cookbook.Fields.COUNTRY_TOTAL, storm.cookbook.Fields.CITY, storm.cookbook.Fields.CITY_TOTAL));
  }
}
